...
# Se definen los argumentos por defecto para el DAG
default_args = {
...
def transformar_data(exec_date):       
    ...
    #Se carga columna de auditoria que setea la fecha de ejecucion del proceso
...
# Se define la Funcion conexion a redshift
...
# Tareas
##1. Se define la tarea para la Extraccion de data
...
#2. Se define la tarea para la Transformacion de data
...
# Definicion orden de tareas a realizar
