...
# Se define la funcion de extraccion de datos
...
# Se define la funcion de transformacion en tabla
def transformar_data(exec_date):       
    ...
    # Seleccionar las 8 columnas más importantes o relevantes para el negocio
    ...
    #Se carga columna que se utilizara de auditoria, donde marcara la fecha de ejecucion
...
# Se define funcion conexion a redshift
...
# Se define la funcion de envio de data
def cargar_data(exec_date):
    ...
    from psycopg2.extras import execute_values
    cur = conn.cursor()
    # Define the table name (tabla a actualizar)
    table_name = 'steikedgar99_coderhouse.stg_countries'
    # Define the columns you want to insert data into
    columns = columns
    # Generate 
...
def enviar_email(exec_date):
    ...
    try:
        ...
        x.starttls()
        x.login('steikedgar991@gmail.com','edgar1999')
        fecha = datetime.now()
        subject='Corrida del API con datos al ' + str(fecha)
        body_text='El proceso a corrido de forma satisfactoria '
        message='Subject: {}\n\n{}'.format(subject,body_text)
        x.sendmail('steikedgar991@gmail.com','steikedgar991@gmail.com',message)
...
# Tareas
##1. Extraccion de la data de origen
...
# 3. Tarea de Envio de data 
# 3.1 Tarea para Conexion a base de datos
...
# 3.2 Tarea para el envio final de la data
